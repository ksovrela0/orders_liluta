...
<body class="main-body main-sidebar-hide">
		...
		<div class="main-content side-content pt-0">
			...
			<div class="container-fluid">
				...
				<div class="page-header">
					<div>
						<h2 class="main-content-title tx-24 mg-b-5">კლიენტები</h2>
						<ol class="breadcrumb">
							<li class="breadcrumb-item"><a href="#">პარამეტრები</a></li>
							<li class="breadcrumb-item active" aria-current="page">კლიენტები</li>
						</ol>
					</div>
				</div>
				<!-- End Page Header -->
	...
	<div title="კლიენტი" id="get_edit_page">
		<p><span class="ui-icon ui-icon-alert" style="float:left; margin:12px 12px 20px 0;"></span>These items will be permanently deleted and cannot be recovered. Are you sure?</p>
	</div>
	<script>
	var aJaxURL = "server-side/clients.action.php";
