...
<body class="main-body main-sidebar-hide">
		...
		<div class="main-content side-content pt-0">
			...
			<div class="container-fluid">
				...
				<div class="page-header">
					<div>
						<h2 class="main-content-title tx-24 mg-b-5">რეპორტი - ჭრა</h2>
						<ol class="breadcrumb">
							<li class="breadcrumb-item"><a href="#">რეპორტები</a></li>
							<li class="breadcrumb-item active" aria-current="page">რეპორტი - ჭრა</li>
						</ol>
					</div>
				</div>
				<!-- End Page Header -->
	...
	function LoadKendoTable_incomming(hidden){
		...
		const kendo = new kendoUI();
		kendo.loadKendoUI(aJaxURL,'get_list_cut',itemPerPage,columnsCount,columnsSQL,gridName,actions,editType,columnGeoNames,filtersCustomOperators,showOperatorsByColumns,selectors,hidden, 1, locked, lockable);
