		...
		<div class="main-content side-content pt-0">
			...
			<div class="container-fluid">
				...
				<div class="page-header">
					<div>
						<h2 class="main-content-title tx-24 mg-b-5">სამუშაო ჯგუფები</h2>
						<ol class="breadcrumb">
							<li class="breadcrumb-item"><a href="#">პარამეტრები</a></li>
							<li class="breadcrumb-item active" aria-current="page">სამუშაო ჯგუფები</li>
						</ol>
					</div>
				</div>
				<!-- End Page Header -->
...
function GetDate(iname) {
    ...
    $(document).on("dblclick", "#work_group_users tr.k-state-selected", function () {
	...
	$(document).on("dblclick", "#work_groups tr.k-state-selected", function () {
