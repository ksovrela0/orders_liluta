...
<head>
	...
	.k-master-row td:has(.make_me_red) {
...
<body class="main-body main-sidebar-hide">
		...
		<div class="main-content side-content pt-0">
			...
			<div class="container-fluid">
				...
				<div class="page-header">
					<div>
						<h2 class="main-content-title tx-24 mg-b-5">პროცესები</h2>
						<ol class="breadcrumb">
							<li class="breadcrumb-item"><a href="#">პარამეტრები</a></li>
							<li class="breadcrumb-item active" aria-current="page">პროცესები</li>
						</ol>
					</div>
				</div>
				<!-- End Page Header -->
	...
	<script>
	var aJaxURL = "server-side/proccess.action.php";
	...
	function save_category(){
		...
		params.act 			= 'save_manuf';
		params.id 			= $("#proc_id").val();
		params.def_price 	= $("#def_price").val();
