...
<body class="main-body">
		...
		<div class="main-content side-content pt-0">
			...
			<div class="container-fluid">
				...
				<div class="page-header">
					<div>
						<h2 class="main-content-title tx-24 mg-b-5">მინის ტიპები</h2>
						<ol class="breadcrumb">
							<li class="breadcrumb-item"><a href="#">პარამეტრები</a></li>
							<li class="breadcrumb-item active" aria-current="page">მინის ტიპები</li>
						</ol>
					</div>
				</div>
				<!-- End Page Header -->
	...
	<div title="ტიპი" id="get_edit_page">
