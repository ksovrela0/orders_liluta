...
switch($act){
    case 'raskroi_excel':
        ...
        $db->setQuery(" SELECT  products_glasses.id,
                                ...
                                products_glasses.glass_width+products_glasses.glass_width_add AS glass_width,
                                products_glasses.glass_height+products_glasses.glass_height_add AS glass_height,
                                ...
                                ROUND(((products_glasses.glass_width+products_glasses.glass_width_add) * (products_glasses.glass_height+products_glasses.glass_height_add))/1000000,2) AS kv_m,
        ...
        foreach($data AS $glass){
            ...
            $objPHPExcel->getActiveSheet()->SetCellValue('D'.$rowCount, $glass['glass_ids']);
