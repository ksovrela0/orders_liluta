...
<body class="main-body main-sidebar-hide">
		...
		<div class="main-content side-content pt-0">
			...
			<div class="container-fluid">
				...
				<div class="page-header">
					<div>
						<h2 class="main-content-title tx-24 mg-b-5">რეპორტი - წრთობა</h2>
						<ol class="breadcrumb">
							<li class="breadcrumb-item"><a href="#">რეპორტები</a></li>
							<li class="breadcrumb-item active" aria-current="page">რეპორტი - წრთობა</li>
						</ol>
					</div>
				</div>
				<!-- End Page Header -->
				...
				<div class="row">
                    <div class="col-md-2">
                        ...
                        <input data-nec="0" style="  width:95%; border: 2px solid #413241; text-align: center;font-size: 20px; color: black;
							height: 28px;
							font-size: 16px;
							margin-bottom: 10px;
							border-radius: 14px;
	...
	function LoadKendoTable_incomming(hidden){
		...
		//KendoUI CLASS CONFIGS BEGIN
		var aJaxURL	        =   "server-side/reports.action.php";
		var gridName        = 	'users';
		...
		const kendo = new kendoUI();
		kendo.loadKendoUI(aJaxURL,'get_list_kalioni',itemPerPage,columnsCount,columnsSQL,gridName,actions,editType,columnGeoNames,filtersCustomOperators,showOperatorsByColumns,selectors,hidden, 1, locked, lockable);
