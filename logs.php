...
<body class="main-body main-sidebar-hide">
		...
		<div class="main-content side-content pt-0">
			...
			<div class="container-fluid">
				...
				<div class="page-header">
					<div>
						<h2 class="main-content-title tx-24 mg-b-5">ლოგები</h2>
						<ol class="breadcrumb">
							<li class="breadcrumb-item"><a href="#">რეპორტები</a></li>
							<li class="breadcrumb-item active" aria-current="page">ლოგები</li>
						</ol>
					</div>
				</div>
				<!-- End Page Header -->
	...
	function LoadKendoTable_incomming(hidden){
		...
		//KendoUI CLASS CONFIGS BEGIN
		var aJaxURL	        =   "server-side/logs.action.php";
		var gridName        = 	'users';
		...
		const kendo = new kendoUI();
		kendo.loadKendoUI(aJaxURL,'get_list_log',itemPerPage,columnsCount,columnsSQL,gridName,actions,editType,columnGeoNames,filtersCustomOperators,showOperatorsByColumns,selectors,hidden, 1, locked, lockable);
