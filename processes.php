...
<body class="main-body">
	...
	function GetDate(iname) {
			...
			function LoadKendoTable_main(hidden) {
				...
				var itemPerPage = 100;
				var columnsCount = 10;
				var columnsSQL = ["id:string", "datetime:string", "client:string", "client_phone:string", "client_addr:string", "cliddent_addr:string", "infooo:string", "avans:string", "add_money:string", "left_to_pay:string", "status:string"];
